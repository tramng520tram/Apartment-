            ...
            <div class="card mb-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-5">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <img src="<?php echo e(asset('./assets/img/12.png')); ?>" style="border-radius:10px; height: 450px; width: 450px; box-shadow:10px 10px 20px 0px rgba(181 181 181);" id="zoom-image">
                                </div>
                                <div class="col-6"><br>
                                    <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <ul class="square" style="margin-left: 40px;">
                                            <li><img src="<?php echo e(asset('./assets/img/xanhduong.png')); ?>" alt="" style="width:5%;">     Phòng đơn / 47,75m²</li><br>
                                            <li><img src="<?php echo e(asset('./assets/img/nau.png')); ?>" alt="" style="width:5%;">     Phòng đôi / 63m² - 68m²</li><br>
                                            <li><img src="<?php echo e(asset('./assets/img/hong.png')); ?>" alt="" style="width:5%;">     Phòng gia đình / 71,1m² - 71,3m²</li><br>
                                            <li><img src="<?php echo e(asset('./assets/img/xanhla.png')); ?>" alt="" style="width:5%;">     Căn hộ Duplex / 71,1m² - 71,3m²</li>
                                        </ul>
                                    </div>
                                    
                                </div>
                                <div class="col-6">
                                    <img src="<?php echo e(asset('./assets/img/vitri.jpg')); ?>" alt="">
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="blog-grid">
                                        <div class="blog-img">
                                            ...
                                            <a href="#">
                                                <img src="<?php echo e(asset('./assets/img/13.jpg')); ?>" title="" alt="" style="width: 350px; height:250px;">
                                            </a>
                                        </div>
                                        <div class="blog-info">
                                ...
                                <div class="col-lg-4">
                                    <div class="blog-grid">
                                        <div class="blog-img">
                                            ...
                                            <a href="#">
                                                <img src="<?php echo e(asset('./assets/img/14.jpg')); ?>" title="" alt="" style="width: 350px; height:250px;">
                                            </a>
                                        </div>
                                        <div class="blog-info">
                                ...
                                <div class="col-lg-4">
                                    <div class="blog-grid">
                                        <div class="blog-img">
                                            ...
                                            <a href="#">
                                                <img src="<?php echo e(asset('./assets/img/15.jpg')); ?>" title="" alt="" style="width: 350px; height:250px;">
                                            </a>
                                        </div>
                                        <div class="blog-info">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('trangchu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS FX506L\OneDrive\Desktop\quanlychungcu_2\resources\views/trangchu1.blade.php ENDPATH**/ ?>