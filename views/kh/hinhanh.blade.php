...
@section('content')
<div class="container">
    <h1 style="margin-top:45px;margin-bottom:45px;">Thông tin dự án</h1>
    <div class="row" style="margin-top: -55px;margin-bottom: 35px; margin-left: 520px;">
        <hr>
    ...
    <div class="row">
      <div class="col-md-5">
        <div class="img-box">
          <img src="{{asset('./assets/img/hoboi.jpg')}}" alt="">
        </div>
      </div>
      <div class="col-md-7">
