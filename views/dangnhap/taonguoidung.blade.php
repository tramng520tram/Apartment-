    ...
    <section class="login">
        <div class="login_box">
            <div class="left">
                ...
                <div class="contact">
                    <form action="{{ route('trangchu.taonguoidungPost') }}" method="POST" class="form" style="margin-top: 19px;">
                        @csrf
                        <h3>ĐĂNG KÝ</h3>
                        <div class="row">
                                <input required name="email" class="form-control" type="text" placeholder="Email">
                                <input required name="name" class="form-control" type="text"placeholder="Họ và tên">
                                <div class="row">
                                    <div class="col-6">
                                        <input required name="CCCD" class="form-control" type="text" placeholder="CCCD/CMND">
                                    </div>
                                    <div class="col-6">
                                        <input required name="SDT" class="form-control" type="text"placeholder="SDT">
                                    </div>
                                </div>
                            {{-- Gioitinh --}}
                            <div class="row">
                                <div class="col-6">
                                    <input style="border: none;" required name="GioiTinh" class="form-control" type="text" placeholder="Giới tính:" disabled>
                                </div>
                                <div class="col-3" style="margin-top: 25px ">
                                    <div class="form-check form-check-inline">
                                        <input class="gt form-check-input" type="radio" id="male" name="GioiTinh" value="male">
                                        <label class="form-check-label" for="male" style="margin-top: -18px; ">Nam</label>
                                    </div>
                                </div>
                                <div class="col-3" style="margin-top: 25px ">
                                    <div class="form-check form-check-inline">
                                        <input class="gt form-check-input" type="radio" id="male" name="GioiTinh" value="male">
                                        <label class="form-check-label" for="male" style="margin-top: -18px; ">Nữ</label>
                                    </div>
                                </div>
                            </div>
                            
                            {{-- Gioitinh --}}
                                <input required name="password" class="form-control fill-password" type="password"placeholder="Mật khẩu">
                        </div>
                        ...
                        <p style="margin-top: 5px;margin-bottom: 0rem; margin-left: 197px ">Quay trở lại <a href="{{route('trangchu.dangnhap')}}">Đăng nhập</a></p>
                    </form>
