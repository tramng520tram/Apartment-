...
@section('content')
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="media blog-media shadow">
                                                                        ...
                                                                        <a href="blog-post-left-sidebar.html"><img
                                                                                ...
                                                                                src="{{ asset('storage/' . $showphong->img) }}"
                                                                                alt="Generic placeholder image"></a>
                                                                        <div class="media-body ">
                                                                            <a href="">
                                                                                <h5 class="mt-0">
                                                                                    {{ $showphong->tenphong }}</h5>
                                                                            </a>
                                                                            <p>Loại phòng:
                                                                                <b>{{ $showphong->name_loaiphong->tenloaiphong }}</b>
                                                                            </p>
                                                                            <p>Tầng:
                                                                                <b>{{ $showphong->name_tang->name }}</b>
                                                                            </p>
                                                                            <p>Giá phòng: <b>{{ number_format($showphong->giaphong, 0, '.', ',')  }} </b>
                                                                            </p>
                                                                            <p>Trạng thái phòng:
                                                                                @if ($showphong->status == phong::NULL)
                                                                            ...
                                                                            {{-- <a href="blog-post-left-sidebar.html" class="post-link bg-primary text-center text-white pt-2 pb-2" >Thông tin chi tiết</a> --}}
                                                                            <button type="button"
                                                                                class="w-100 btn post-link text-center text-white pt-2 pb-2"
                                                                                style="border-radius:20px; background-color:#008375;"
                                                                                onclick="ThemPhong({{ $showphong->id }})">
                                                                                Đặt phòng
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="card-body px-0 pt-0 pb-2">
                                            ...
                                            <section class="home-blog bg-sand">
                                                <div class="container">
                                                    ...
                                                    <div class="row ">
                                                        @foreach ($phong as $showphong)
                                                            @if ($showphong->status == phong::REQUEST)
                                                                {{-- {{dd($showphong)}} --}}
                                                                <div class="col-md-6">
                                                                    <div class="media blog-media shadow">
                                                                        ...
                                                                        <div class="media-body ">
                                                                            ...
                                                                            <p>Giá phòng: <b>{{ number_format($showphong->giaphong, 0, '.', ',')  }}
                                                                                </b>
                                                                            </p>
                                                                            <p>Trạng thái phòng:
                                                                                @if ($showphong->status == phong::NULL)
                                        ...
                                        <div class="card-body px-0 pt-0 pb-2">
                                            ...
                                            <section class="home-blog bg-sand">
                                                <div class="container">
                                                    ...
                                                    <div class="row ">
                                                        @foreach ($phong as $showphong)
                                                            @if ($showphong->status == phong::ORDER)
                                                                {{-- {{dd($showphong)}} --}}
                                                                <div class="col-md-6">
                                                                    <div class="media blog-media shadow">
                                        ...
                                        <div class="card-body px-0 pt-0 pb-2">
                                            ...
                                            <section class="home-blog bg-sand">
                                                <div class="container">
                                                    ...
                                                    <div class="row ">
                                                        @foreach ($phong as $showphong)
                                                            @if ($showphong->status == phong::CANCEL)
                                                                {{-- {{dd($showphong)}} --}}
                                                                <div class="col-md-6">
                                                                    <div class="media blog-media shadow">
                                                                        ...
                                                                        <div class="media-body ">
                                                                            ...
                                                                            class="w-100 btn post-link text-center text-white pt-2 pb-2"
                                                                            style="border-radius:20px; background-color:#008375;"
                                                                                onclick="Baotri({{ $showphong->id }})"
                                                                                @if ($showphong->status == phong::ORDER) disabled @endif>
                                                                                Bảo trì
                                                                            </button>
                                                                        </div>
                                                                    </div>
    ...
    <!-- Modal -->
    @include('list.modal')
    @include('list.modal_duyet')
    @include('list.modal_duyetdat')
    @include('list.modal_baotri')
@endsection
@section('js')
    ...
    <script>
        ...
        function HuyPhong() {
            $.ajax({
                url: "{{ route('thongtin.huyphong_post') }}",
                method: "POST",
                data: {
                    "_token": "{{ csrf_token() }}",
